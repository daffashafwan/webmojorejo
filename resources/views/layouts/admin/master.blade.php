...
<head>
    ...
    <title>Admin Desa Mojorejo</title>
    ...
    <link rel="stylesheet" id="css-main" href="{{asset('assets/css/image-upload.css')}}">
    @yield('css')
            ...
            <div class="content-header bg-white-5">
                ...
                <a class="font-w600 text-dual" href="index.html">
                    <span class="smini-hide">
                        <span class="font-w200 font-size-56">Admin</span> <span class="font-w400">Desa</span>
                    </span>
                </a>
                <!-- END Logo -->
                ...
                <ul class="nav-main">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                            ...
                            <span class="nav-main-link-name">Fitur Admin</span>
                        </a>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown"
                            ...
                            <img class="rounded" src="{{asset('assets/admin/media/avatars/avatar10.jpg')}}" alt="Header Avatar"
                                style="width: 18px;">
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm"
                            ...
                            <div class="p-3 text-center bg-primary">
                                <img class="img-avatar img-avatar48 img-avatar-thumb"
                                    src="{{asset('assets/admin/media/avatars/avatar10.jpg')}}" alt="">
                            </div>
                            <div class="p-2">
            ...
            <div class="content py-3">
                <div class="row font-size-sm">
                    <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right">
                        Dikembangkan Oleh Kelompok PMM UMM 94 Gelombang 3
                    </div>
                    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                        <a class="font-w600" href="" target="_blank">Desa Mojorejo Kota Batu</a> &copy; <span
